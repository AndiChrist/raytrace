...
public class MathUtilTest {
    ...
    public void testQuadraticFormula1() {
        Set<Double> solutions = MathUtil.quadraticFormula(4, -12, -40); // 4x² - 12x - 40
    ...
    public void testQuadraticFormula2() {
        Set<Double> solutions = MathUtil.quadraticFormula(1, 2, -35); // x² + 2x - 35
        assertEquals(solutions.size(), 2);
    ...
    public void testQuadraticFormula3() {
        Set<Double> solutions = MathUtil.quadraticFormula(1, -4, 4); // x² - 4x + 4
    ...
    public void testQuadraticFormula4() {
        Set<Double> solutions = MathUtil.quadraticFormula(1, 12, 37); // x² + 12x + 37
        assertEquals(solutions.size(), 0);
    }

    @Test
    public void testQuadraticFormula5() {
        Set<Double> solutions = MathUtil.quadraticFormula(1, 0, -100);  // x² - 100
        assertEquals(solutions.size(), 2);
    ...
    public void testQuadraticFormula6() {
        ...
        Set<Double> solutions = MathUtil.quadraticFormula(coefficients);
        assertEquals(solutions.size(), 2);
